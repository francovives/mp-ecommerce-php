...
switch ($_GET['collection_status']) {
    case 'approved':
        ...
        echo "<div class='message_success'>
                <h5>Felicitaciones, su pago ha sido aprovado</h5>
                <p>detalles de su pago:</p>
                <ul>
    ...
    case 'rejected':
        ...
        echo "<div class='message_fail'>
            <h5>Lo sentimos, su pago ha sido rechazado</h5>
            </div>";
    ...
    case 'failure':
        ...
        echo "<div class='message_fail'>
                <h5>Lo sentimos, su pago ha fallado</h5>
                </div>";
        ...
        case 'pending':
            ...
            echo "<div class='message_pending'>
                    <h5>Ha seleccionado un metodo de pago offline, su pago se encuentra pendiente</h5>
                    </div>";
